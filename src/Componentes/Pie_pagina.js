...
class Pie_pagina extends Component {
    render() {
        let ima=require('./facebook.svg').default;
        return (
            <div>
                ...
                <div className="fluid bg-dark">
                    <footer className="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
                        ...
                        <ul className="nav col-md-4 justify-content-end list-unstyled d-flex">
                            <li className="ms-3"><img className="bi" width="24" height="24" src="https://icons.getbootstrap.com/assets/icons/twitter.svg"/></li>
                            <li className="ms-3"><img className="bi" width="24" height="24" src={ima}/></li>
